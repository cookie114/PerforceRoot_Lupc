...
DEFINE_PACKAGE_TAR=libsoup-2.40.3.tar.xz
DEFINE_PACKAGE_NAME=libsoup
DEFINE_PACKAGE_VERSION=2.40.3
...
DEFINE_PACKAGE_DESCRIPTION="http client server port."
...
DEFINE_CONFIGURE_FLAGS="--build=i386-linux --host=${DEFINE_HOST} --prefix=${DEFINE_BINARY} --without-gnome"
