...
DEFINE_PACKAGE_TAR=openssl-1.0.0a.tar.gz
DEFINE_PACKAGE_NAME=openssl
DEFINE_PACKAGE_VERSION=1.0.0a
...
DEFINE_PACKAGE_DESCRIPTION="Openssl libraries."
...
DEFINE_CONFIGURE_FLAGS="linux-mips -DL_ENDIAN linux:${DEFINE_HOST}-gcc ${DEFINE_CFLAGS} "
