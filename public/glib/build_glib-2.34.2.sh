...
DEFINE_PACKAGE_TAR=glib-2.34.2.tar.xz
DEFINE_PACKAGE_NAME=glib
DEFINE_PACKAGE_VERSION=2.34.2
...
DEFINE_CONFIGURE_FLAGS="--build=i386-linux --host=${DEFINE_HOST} --prefix=${DEFINE_BINARY} --with-html-dir=/tmp/dump glib_cv_stack_grows=no glib_cv_uscore=no ac_cv_func_posix_getgrgid_r=no ac_cv_func_posix_getpwuid_r=no"
echo "$1"
