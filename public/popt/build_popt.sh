...
DEFINE_PACKAGE_TAR=popt-1.14.tar.gz
DEFINE_PACKAGE_NAME=popt
DEFINE_PACKAGE_VERSION=1.14
...
DEFINE_CONFIGURE_FLAGS="--host=${DEFINE_HOST}  --disable-nls --with-kernel-support ac_cv_va_copy=C99"
