...
cd media/gstreamer-1.0 && ./build_gstreamer-1.0.4.sh && cd ../..
cd media/gstreamer-1.0 && ./build_gst-plugins-base-1.0.4.sh && cd ../..
cd media/gstreamer-1.0 && ./build_gst-plugins-good-1.0.4.sh && cd ../..
cd media/gstreamer-1.0 && ./build_gst-plugins-bad-1.0.4.sh && cd ../..
cd media/gstreamer-1.0 && ./build_gst-plugins-ugly-1.0.4.sh && cd ../..
# cd media/gstreamer && ./build_gst-plugins-loks-1.0.0.sh && cd ../..
