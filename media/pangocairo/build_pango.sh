...
DEFINE_PACKAGE_TAR=pango-1.28.3.tar.bz2
DEFINE_PACKAGE_NAME=pango
DEFINE_PACKAGE_VERSION=1.28.3
...
DEFINE_PACKAGE_DESCRIPTION="Pango library."
...
DEFINE_CONFIGURE_FLAGS="--host=${DEFINE_HOST}  --without-x"
