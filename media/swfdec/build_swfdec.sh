...
DEFINE_PACKAGE_TAR=swfdec-0.8.4.tar.gz
DEFINE_PACKAGE_NAME=swfdec
DEFINE_PACKAGE_VERSION=0.8.4
...
DEFINE_PACKAGE_DESCRIPTION="a adobe FLASH decoder."
...
DEFINE_CONFIGURE_FLAGS="--host=${DEFINE_HOST} t"
