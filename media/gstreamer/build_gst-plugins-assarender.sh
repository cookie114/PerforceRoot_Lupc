...
DEFINE_PACKAGE_TAR=
DEFINE_PACKAGE_NAME=gst-plugins-assarender
...
DEFINE_PACKAGE_DESCRIPTION="gstreamer ass/ssa render plugin."
...
DEFINE_CONFIGURE_FLAGS="--host=${DEFINE_HOST} --target=${DEFINE_HOST}  "
