...
DEFINE_PACKAGE_TAR=gst-plugins-good-0.10.30.tar.bz2
DEFINE_PACKAGE_NAME=gst-plugins-good
DEFINE_PACKAGE_VERSION=0.10.30
...
--disable-xvideo --disable-xshm -disable-annodex --disable-cairo --disable-gdk_pixbuf --disable-gconf --disable-libcaca --disable-libpng --disable-pulse --disable-examples --enable-experimental"
