...
DEFINE_PACKAGE_TAR=gst-plugins-bad-0.10.22.tar.bz2
DEFINE_PACKAGE_NAME=gst-plugins-bad
DEFINE_PACKAGE_VERSION=0.10.22
...
--disable-apexsink --disable-librfb --disable-directfb --disable-sdl --disable-cog --disable-examples"
