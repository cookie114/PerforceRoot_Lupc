...
DEFINE_PACKAGE_TAR=libass-0.9.13.tar.gz
DEFINE_PACKAGE_NAME=libass
DEFINE_PACKAGE_VERSION=0.9.13
...
DEFINE_PACKAGE_DESCRIPTION="libass."
...
DEFINE_CONFIGURE_FLAGS="--host=${DEFINE_HOST} --target=${DEFINE_HOST} --enable-test "
