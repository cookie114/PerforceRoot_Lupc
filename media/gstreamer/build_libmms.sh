...
DEFINE_PACKAGE_TAR=libmms-0.6.2.tar.gz
DEFINE_PACKAGE_NAME=libmms
DEFINE_PACKAGE_VERSION=0.6.2
...
DEFINE_PACKAGE_DESCRIPTION="libmms."
...
DEFINE_CONFIGURE_FLAGS="--host=${DEFINE_HOST} --target=${DEFINE_HOST} --with-ffmpeg-extra-configure="--target-os=linux" "
